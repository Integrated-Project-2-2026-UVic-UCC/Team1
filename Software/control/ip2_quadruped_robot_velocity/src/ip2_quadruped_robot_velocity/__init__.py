...
from .rl_cfg import quad_bot_ppo_runner_cfg, quad_bot2_ppo_runner_cfg
...
#Nico
register_mjlab_task(
    task_id="Mjlab-Velocity-Flat-Quad-Bot",
    env_cfg=quad_bot_flat_env_cfg(),
    play_env_cfg=quad_bot_flat_env_cfg(play=True),
    rl_cfg=quad_bot2_ppo_runner_cfg(),
    runner_cls=VelocityOnPolicyRunner,
)